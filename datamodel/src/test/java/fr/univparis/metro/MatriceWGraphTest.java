...
public class MatriceWGraphTest{
    ...
    public void matriceWGraphTest(){
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Porte des Lilas")][m.getSetOfVertices().get("Temple")], 780.0, 0.0);
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Charles de Gaulle - Etoile")][m.getSetOfVertices().get("République")], 1050.0, 0.0);
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Robespierre")][m.getSetOfVertices().get("Marx Dormoy")], 1740.0, 0.0);
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Botzaris$2")][m.getSetOfVertices().get("Chemin Vert")], 930.0, 0.0);
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Gabriel Péri")][m.getSetOfVertices().get("Mirabeau")], 1770.0, 0.0);
        ...
        assertEquals(m.getDirect()[m.getSetOfVertices().get("Porte Dauphine")][m.getSetOfVertices().get("Olympiades")], 1470.0, 0.0);
